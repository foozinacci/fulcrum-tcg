...
// ------------------------------------------------------------
// 60-CARD SINGLE-PACT PRECON DECKS (100% COLOR IDENTITY PURE)
// ------------------------------------------------------------

export const PRECON_COREFEAST: Card[] = [
  ...
  ATTACHMENT_COREFEAST_02, ATTACHMENT_COREFEAST_02, ATTACHMENT_COREFEAST_02,
...
export const PRECON_IRONBOUND: Card[] = [
  ...
  ATTACHMENT_IRONBOUND_02, ATTACHMENT_IRONBOUND_02, ATTACHMENT_IRONBOUND_02,
...
export const PRECON_VOIDHALLOW: Card[] = [
  ...
  BEING_VOIDHALLOW_04, BEING_VOIDHALLOW_04, BEING_VOIDHALLOW_04,
  ...
  CHARM_VOIDHALLOW_02, CHARM_VOIDHALLOW_02, CHARM_VOIDHALLOW_02,
  ...
  ATTACHMENT_VOIDHALLOW_02, ATTACHMENT_VOIDHALLOW_02, ATTACHMENT_VOIDHALLOW_02,
...
export const PRECON_CHARMBRAND: Card[] = [
  BEING_CHARMBRAND_01, BEING_CHARMBRAND_01, BEING_CHARMBRAND_01,
  BEING_CHARMBRAND_02, BEING_CHARMBRAND_02, BEING_CHARMBRAND_02,
  BEING_CHARMBRAND_03, BEING_CHARMBRAND_03, BEING_CHARMBRAND_03,
  BEING_CHARMBRAND_04, BEING_CHARMBRAND_04, BEING_CHARMBRAND_04,
  BEING_CHARMBRAND_05, BEING_CHARMBRAND_05, BEING_CHARMBRAND_05,
  BEING_CHARMBRAND_06, BEING_CHARMBRAND_06, BEING_CHARMBRAND_06,
  CHARM_CHARMBRAND_01, CHARM_CHARMBRAND_01, CHARM_CHARMBRAND_01,
  CHARM_CHARMBRAND_02, CHARM_CHARMBRAND_02, CHARM_CHARMBRAND_02,
  CHARM_CHARMBRAND_03, CHARM_CHARMBRAND_03, CHARM_CHARMBRAND_03,
  ATTACHMENT_CHARMBRAND_01, ATTACHMENT_CHARMBRAND_01, ATTACHMENT_CHARMBRAND_01,
  ATTACHMENT_CHARMBRAND_02, ATTACHMENT_CHARMBRAND_02, ATTACHMENT_CHARMBRAND_02,
...
export const PRECON_RUNESCALE: Card[] = [
  ...
  BEING_RUNESCALE_04, BEING_RUNESCALE_04, BEING_RUNESCALE_04,
  ...
  CHARM_RUNESCALE_02, CHARM_RUNESCALE_02, CHARM_RUNESCALE_02,
  ...
  ATTACHMENT_RUNESCALE_02, ATTACHMENT_RUNESCALE_02, ATTACHMENT_RUNESCALE_02,
...
export const PRECON_ROTWATCH: Card[] = [
  BEING_ROTWATCH_01, BEING_ROTWATCH_01, BEING_ROTWATCH_01,
  BEING_ROTWATCH_02, BEING_ROTWATCH_02, BEING_ROTWATCH_02,
  BEING_ROTWATCH_03, BEING_ROTWATCH_03, BEING_ROTWATCH_03,
  BEING_ROTWATCH_04, BEING_ROTWATCH_04, BEING_ROTWATCH_04,
  BEING_ROTWATCH_05, BEING_ROTWATCH_05, BEING_ROTWATCH_05,
  BEING_ROTWATCH_06, BEING_ROTWATCH_06, BEING_ROTWATCH_06,
  CHARM_ROTWATCH_01, CHARM_ROTWATCH_01, CHARM_ROTWATCH_01,
  CHARM_ROTWATCH_02, CHARM_ROTWATCH_02, CHARM_ROTWATCH_02,
  CHARM_ROTWATCH_03, CHARM_ROTWATCH_03, CHARM_ROTWATCH_03,
  ATTACHMENT_ROTWATCH_01, ATTACHMENT_ROTWATCH_01, ATTACHMENT_ROTWATCH_01,
  ATTACHMENT_ROTWATCH_02, ATTACHMENT_ROTWATCH_02, ATTACHMENT_ROTWATCH_02,
...
export function getPreconDeckForAvatar(avatar?: Card): Card[] {
  if (!avatar) return PRECON_COREFEAST;
  const pact = avatar.pact?.toLowerCase() || '';
  if (pact.includes('ironbound')) return PRECON_IRONBOUND;
  if (pact.includes('voidhallow')) return PRECON_VOIDHALLOW;
  if (pact.includes('charmbrand')) return PRECON_CHARMBRAND;
  if (pact.includes('runescale')) return PRECON_RUNESCALE;
  if (pact.includes('rotwatch')) return PRECON_ROTWATCH;
  return PRECON_COREFEAST;
}

export const STARTER_DECK_A: Card[] = PRECON_COREFEAST;
export const STARTER_DECK_B: Card[] = PRECON_IRONBOUND;
