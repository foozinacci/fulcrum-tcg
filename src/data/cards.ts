...
export const GLUTTRIX_COREFEASTER: Card = {
  ...
  grit: 2,
  coreAttackRatio: 1.5,
  description: "Your Core cap is increased +5. Draw +1 extra card at turn start.\nPay 3 Core: Tutor a Relic or Rune into hand (1x/turn).",
...
export const VORRATH_IRONBOUND: Card = {
  ...
  isDynamicStats: true,
  coreAttackRatio: 1.5,
  description: "Edge & Grit equal unused Core pool (*/*).\nSacrifice an Attachment to tutor an Attachment (Load <= sacrificed Core) & attach to Vorrath (1x/turn).",
...
export const NYSSARA_VOIDHALLOWER: Card = {
  ...
  grit: 5,
  coreAttackRatio: 1.5,
  description: "Whenever an opponent converts a card for Core, siphon 2 Core from them.\nPay 3 Core: Target player converts top card of deck for its Core value.",
...
export const GROTHMAW_CHARMBRANDED: Card = {
  ...
  grit: 3,
  coreAttackRatio: 1.5,
  description: "Converting a Charm lets you cast it from graveyard that turn, then exile it.\nCasting a Charm after Grothmaw deals combat damage to a player copies that Charm.",
...
export const KAZRITH_RUNESCALE: Card = {
  ...
  grit: 2,
  coreAttackRatio: 1.5,
  description: "Other Beings enter play Alert instead of Dormant.\nWhenever a Rune is exhausted for Core, your Beings gain +1 Edge & +1 Grit until end of turn.",
...
export const KHARV_ROTWATCH: Card = {
  ...
  grit: 1,
  coreAttackRatio: 1.5,
  description: "Convert any card from hand into Core (bypasses turn-drawn rule).\nPay X Core (X = Load) to cast any card from graveyard (exiled on resolution or death).",
