...
export const GLUTTRIX_COREFEASTER: Card = {
  ...
  grit: 2,
  coreAttackRatio: 1.5,
  description: 'Pace 6 [Corefeast]. Ability 1: Draw +1 extra card at turn start. Ability 2: Pay 3 Core to Tutor a Relic or Rune (1x/turn).',
...
export const VORRATH_IRONBOUND: Card = {
  ...
  isDynamicStats: true,
  coreAttackRatio: 1.5,
  description: "Pace 4 [Ironbound]. Ability 1: Edge & Grit equal unused Core pool (*/*). Ability 2: Sacrifice an Attachment to tutor an Attachment (Load <= sacrificed Core) & attach to Vorrath (1x/turn).",
...
export const NYSSARA_VOIDHALLOWER: Card = {
  ...
  grit: 5,
  coreAttackRatio: 1.5,
  description: 'Pace 5 [Voidhallow]. Ability 1: Whenever an opponent converts a card for Core, siphon 2 Core from them. Ability 2: Pay 3 Core: Target player converts top card of deck for its Core value.',
...
export const GROTHMAW_CHARMBRANDED: Card = {
  ...
  grit: 3,
  coreAttackRatio: 1.5,
  description: 'Pace 3 [Charmbrand]. Ability 1: Converting a Charm lets you cast it from graveyard that turn, then exile it. Ability 2: Casting a Charm after Grothmaw deals combat damage to a player copies that Charm.',
...
export const KAZRITH_RUNESCALE: Card = {
  ...
  grit: 2,
  coreAttackRatio: 1.5,
  description: 'Pace 2 [Runescale]. Ability 1: Other Beings enter play Alert instead of Dormant. Ability 2: Whenever a Rune is exhausted for Core, your Beings gain +1 Edge & +1 Grit until end of turn.',
...
export const KHARV_ROTWATCH: Card = {
  ...
  grit: 1,
  coreAttackRatio: 1.5,
  description: 'Pace 1 [Rotwatch]. Ability 1: Convert any card from hand into Core (bypasses turn-drawn rule). Ability 2: Pay X Core (X = Load) to cast any card from graveyard (exiled on resolution or death).',
